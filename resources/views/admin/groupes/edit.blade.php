...
@section('header-title', 'Modifier le Groupe')
...
<div class="py-6">
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-5 flex items-center gap-2 text-sm text-slate-400">
            ...
            <span class="text-slate-600 font-medium">Modifier — {{ $groupe->nom }}</span>
        </div>
        ...
        <div class="bg-white shadow rounded-2xl border border-slate-100 overflow-hidden">
            ...
            <div class="px-6 py-5 border-b border-slate-100 bg-gradient-to-r from-indigo-50 to-violet-50">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h2 class="text-base font-bold text-slate-800">Modifier le groupe</h2>
                        <p class="text-xs text-slate-500 mt-0.5">Mettez à jour la division et sa capacité maximale</p>
                    </div>
                </div>
            </div>

            {{-- Form --}}
            <form action="{{ route('admin.groupes.update', $groupe->id) }}" method="POST" class="p-6 space-y-5">
                @csrf @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="number" name="capacite" id="capacite" value="{{ old('capacite', $groupe->capacite) }}" required
