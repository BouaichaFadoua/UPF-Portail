...
@section('header-title', 'Nouveau Module')
...
<div class="py-6">
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-5 flex items-center gap-2 text-sm text-slate-400">
            ...
            <span class="text-slate-600 font-medium">Nouveau module</span>
        </div>
        ...
        <div class="bg-white shadow rounded-2xl border border-slate-100 overflow-hidden">
            ...
            <div class="px-6 py-5 border-b border-slate-100 bg-gradient-to-r from-indigo-50 to-violet-50">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h2 class="text-base font-bold text-slate-800">Créer un nouveau module</h2>
                        <p class="text-xs text-slate-500 mt-0.5">Associez-le à une filière et affectez-y un enseignant</p>
                    </div>
                </div>
            </div>

            {{-- Form --}}
            <form action="{{ route('admin.modules.store') }}" method="POST" class="p-6 space-y-5">
                @csrf
                ...
                <div>
                    ...
                    <input type="text" name="nom" id="nom" value="{{ old('nom') }}" required
                           placeholder="Ex : Conception Orientée Objet"
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        ...
                        <input type="number" step="0.5" name="coefficient" id="coefficient" value="{{ old('coefficient', '1.0') }}" required
                    ...
                    <div>
                        ...
                        <input type="number" name="volume_horaire" id="volume_horaire" value="{{ old('volume_horaire', '30') }}" required
                               class="w-full border border-slate-200 rounded-xl px-4 py-2.5 text-sm text-slate-800
                                      focus:outline-none focus:ring-2 focus:ring-primary-300 focus:border-primary-400 transition">
                    </div>
                </div>
